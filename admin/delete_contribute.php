...
if (isset($_POST['confirm_delete'])) {
    ...
    header('Location: admin_contribute_control_panel.php');
    exit();
}
    ...
    <div class="modal-overlay">
        <div class="confirmation-box">
            ...
            <div class="button-group">
                <form action="delete_contribute.php" method="post" style="display: inline;">
                    <input type="hidden" name="id" value="<?php echo htmlspecialchars($id); ?>">
                    <input type="hidden" name="confirm_delete" value="1">
                    <button type="submit" class="confirm-button">Yes, Delete</button>
                </form>
                <a href="admin_contribute_control_panel.php" class="cancel-button">Cancel</a>
            </div>
        </div>
    </div>
</body>
