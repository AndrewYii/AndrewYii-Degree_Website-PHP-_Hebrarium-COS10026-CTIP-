<?php
    echo "<nav>
            <div class='menu'>
                ...
                <ul class='menubar'>
                    <li class='dropdown'>
                        <a href='classify.php'>Classification</a>
                        <ul class='dropdown-menu'>
                            <li>
                                <div class='dropdown-content'>
                                    <div class='dropdown-text'>
                                        <h3><a href='classify.php'>Plant Classification</a></h3>
                    ...
                    <li class='dropdown'>
                        <a href='tutorial-introduction.php'>Tutorial</a>
                        <ul class='dropdown-menu'>
                            <li>
                                <div class='dropdown-content'>
                                    <div class='dropdown-text'>
                                        <h3><a href='tutorial-introduction.php'>Herbarium Specimen Tutorial</a></h3>
                                    ...
                                    <div class='dropdown-description'>
                                        <ul>
                                            ...
                                            <li><a href='tools.php'>Essential Tools for Making Herbarium Specimen</a></li>
                                            <li><a href='tutorial.php'>Ways to Make Herbarium Specimen</a></li>
                                            <li><a href='care.php'>Techniques to Preserve the Herbarium Specimen</a></li>
                                        </ul>
                                    </div>
                                    <div class='dropdown-image'>
                    ...
                    <li class='dropdown'>
                        ...
                        <ul class='dropdown-menu'>
                            <li>
                                <div class='dropdown-content'>
                                    <div class='dropdown-text'>
                                        <h3><a href='identify.php'>Plant Identification Hub</a></h3>
                    ...
                    <li class='dropdown'>
                        <a href='contribution.php'>Contribution</a>
                        <ul class='dropdown-menu'>
                            <li>
                                <div class='dropdown-content'>
                                    <div class='dropdown-text'>
                                        <h3><a href='contribution.php'>Contribute Your Idea</a></h3>
                    ...
                    <li class='dropdown'>
                        ...
                        <ul class='dropdown-menu'>
                            <li>
                                <div class='dropdown-content'>
                                    <div class='dropdown-text'>
                                        <h3><a href='enquiry.php'>Share Your Problems </a></h3>
